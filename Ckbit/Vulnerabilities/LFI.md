Aqui está uma anotação completa sobre **LFI (Local File Inclusion)** com foco em formas de **bypass**, **payloads**, e **explicações detalhadas** sobre seu funcionamento e como utilizá-los.
